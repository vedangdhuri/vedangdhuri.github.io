  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        ...
        <div id="homeImg" className="inline-flex justify-center items-center animate-fade-in mb-10">
          <img
            src={homeImg}
            alt="Vedang Dhuri"
            className="rounded-full transition-all duration-500 mx-auto w-[66vw] sm:w-[48vw] md:w-[44vw] lg:w-[40vw] xl:w-[26vw] 2xl:w-[22vw]"
          />
          {/* Signature */}
        ...
        <div className="space-y-6">
          ...
          <div className="text-1xl md:text-4xl font-bold tracking-tight justify-items-center">
      ...
      <div className="scrolldown">
        <div className="absolute bottom-8 left-1/2 transform -translate-y-2/8 md:-translate-y-1 -translate-x-1/2 flex flex-col items-center animate-bounce">
